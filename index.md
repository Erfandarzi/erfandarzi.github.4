...
<div id ="intro-wrapper" class="l-middle">
	<div id="intro-title-wrapper" class="intro-left">
		<h1 id="intro-title">Hi, I'm Erfan Darzi</h1>
		<div id="intro-subtitle">
			I’m a MS student at the school of Electrical and Computer Engineering, University of Tehran, Iran
			 <!-- advised by Polo Chau and Alex Endert. -->
		</div>
	</div>
	<div class="intro-left">
	<div class="intro-left">
		I research how to enable <b>machine learning </b> at scale and for everyone, by designing and developing deep learning models to help people confidently understand data-driven systems. Besides building tools, I also create <b>data visualizations</b> and write interactive articles to simply communicate complex ideas.
	</div>
	<div style="height: 1rem"></div>
	<div class="intro-left">
		At University of Tehran I work with <a href="https://profile.ut.ac.ir/en/~h.vahabie">Abdol-Hossein Vahabie</a>
	</div>
	<div style="height: 1rem"></div>
	<div>
